              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12.0),
                    Text("Confirm Password", style: Theme.of(context).textTheme.labelSmall!.copyWith(color: white.shade700)),
                    const SizedBox(height: 6),
                    TextFormField(
                      decoration: textInputDecoration.copyWith(
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        Row(children: [
                          Icon((validations["length"] ?? false) ? Ionicons.checkmark : Ionicons.close,
                              size: 14, color: white.shade900),
                          const SizedBox(width: 6),
                          Text("Atleast 8 characters", style: Theme.of(context).textTheme.bodySmall)
                        ]),
                        Row(children: [
                          Icon((validations["nums"] ?? false) ? Ionicons.checkmark : Ionicons.close,
                              size: 14, color: white.shade900),
                          const SizedBox(width: 6),
                          Text("Must have atleast one number", style: Theme.of(context).textTheme.bodySmall)
                        ]),
                        Row(children: [
                          Icon((validations["lowercase"] ?? false) ? Ionicons.checkmark : Ionicons.close,
                              size: 14, color: white.shade900),
                          const SizedBox(width: 6),
                          Text("Must have lowercase letters", style: Theme.of(context).textTheme.bodySmall)
                        ]),
                        Row(children: [
                          Icon((validations["uppercase"] ?? false) ? Ionicons.checkmark : Ionicons.close,
                              size: 14, color: white.shade900),
                          const SizedBox(width: 6),
